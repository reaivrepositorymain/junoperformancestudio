...
export default function TopbarLanguageSelector() {
  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <button
          className="flex items-center gap-2 bg-slate-100 border border-gray-300 rounded-lg px-3 py-1.5 font-semibold text-sm hover:bg-slate-200 transition-colors"
